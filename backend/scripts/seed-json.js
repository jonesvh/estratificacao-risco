...
const DB_PATH = process.env.JSON_DB_PATH ?? './MEDPREV/db.json';
    ...
    questions: [
      {
        ...
        type: 'MULTIPLE_CHOICE', orderIndex: 0, isRequired: true, weight: 1,
      ...
      },
      {
        ...
        type: 'TEXT', orderIndex: 1, isRequired: false, weight: 1,
        helpText: 'Informe a data aproximada do diagnóstico (ex: 01/2024).',
        options: [],
      },
      {
        text: 'Quais doenças crônicas você possui?',
        type: 'MULTIPLE_CHOICE', orderIndex: 2, isRequired: false, weight: 1,
      ...
      },
      {
        ...
        type: 'TEXT', orderIndex: 3, isRequired: false, weight: 1, helpText: null, options: [],
      },
      {
        text: 'Quantidade de doenças crônicas simultâneas',
        type: 'SINGLE_CHOICE', orderIndex: 4, isRequired: true, weight: 1, helpText: null,
        options: [
      ...
      },
      {
        ...
        type: 'SINGLE_CHOICE', orderIndex: 5, isRequired: true, weight: 1,
      ...
      },
      {
        ...
        type: 'SINGLE_CHOICE', orderIndex: 6, isRequired: true, weight: 1, helpText: null,
        options: [
    ...
    questions: [
      {
        ...
        type: 'SINGLE_CHOICE', orderIndex: 0, isRequired: true, weight: 1, helpText: null,
        options: [
      ...
      },
      {
        ...
        type: 'SINGLE_CHOICE', orderIndex: 1, isRequired: true, weight: 1,
      ...
      },
      {
        ...
        type: 'SINGLE_CHOICE', orderIndex: 2, isRequired: true, weight: 1, helpText: null,
        options: [
          { label: 'Nenhuma',   value: 'nenhuma',   score: 0, orderIndex: 0 },
      ...
      },
      {
        ...
        type: 'SINGLE_CHOICE', orderIndex: 3, isRequired: true, weight: 1,
    ...
    questions: [
      {
        ...
        type: 'SINGLE_CHOICE', orderIndex: 0, isRequired: true, weight: 1,
      ...
      },
      {
        ...
        type: 'SINGLE_CHOICE', orderIndex: 2, isRequired: true, weight: 1,
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        type: 'MULTIPLE_CHOICE', orderIndex: 3, isRequired: true, weight: 1,
      ...
      },
      {
        ...
        type: 'TEXT', orderIndex: 4, isRequired: false, weight: 1, helpText: null, options: [],
      },
    ],
  },
];
...
function seed() {
  if (existsSync(DB_PATH)) {
    const existing = JSON.parse(require('fs').readFileSync(DB_PATH, 'utf-8'));
    const hasQuestionnaire = existing.questionnaires?.some((q) => q.title === TITLE);
    if (hasQuestionnaire) {
      console.log('[seed] Questionário já existe:', TITLE);
      return;
    }
  }

  console.log('[seed] Criando questionário:', TITLE);
  ...
  console.log('[seed] Banco inicializado em:', DB_PATH);
  console.log('[seed] Questionário criado:', questionnaire.id);
}
